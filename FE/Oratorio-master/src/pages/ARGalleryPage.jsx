...
const ARGalleryPage = () => {
  ...
  useEffect(() => {
    let mounted = true;
    setLoading(true);
    axios.get('http://192.168.110.100:5000/api/wisata')
      .then(response => {
        if (mounted) {
              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="relative h-56 bg-gradient-to-br from-[#C9E4E2] to-[#005954] overflow-hidden">
                    <img
                      src={`http://192.168.110.100:5000/static/uploads/${item.marker_image}`}
                      alt={item.name}
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <Link 
                      ...
                      onClick={async () => {
                        try {
                          await fetch('http://192.168.110.100:5000/api/history', {
                            method: 'POST',
